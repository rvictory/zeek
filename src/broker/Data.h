 ...
 */
zeek::EnumValPtr get_data_type(zeek::RecordVal* v, zeek::Frame* frame);
 ...
 */
broker::data& opaque_field_to_data(zeek::RecordVal* v, zeek::Frame* f);
 ...
 */
template <typename T>
T& require_data_type(broker::data& d, zeek::TypeTag tag, zeek::Frame* f)
	{
 ...
 */
template <typename T>
inline T& require_data_type(zeek::RecordVal* v, zeek::TypeTag tag, zeek::Frame* f)
	{
...
public:
	...
	SetIterator(zeek::RecordVal* v, zeek::TypeTag tag, zeek::Frame* f)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	...
	SetIterator(zeek::RecordVal* v, ::TypeTag tag, zeek::Frame* f)
...
public:
	...
	TableIterator(zeek::RecordVal* v, zeek::TypeTag tag, zeek::Frame* f)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	[[deprecated("Remove in v4.1. Use the version that takes zeek::TypeTag instead.")]]
	TableIterator(zeek::RecordVal* v, ::TypeTag tag, zeek::Frame* f)
...
public:
	...
	VectorIterator(zeek::RecordVal* v, zeek::TypeTag tag, zeek::Frame* f)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	[[deprecated("Remove in v4.1. Use the version that takes zeek::TypeTag instead.")]]
	VectorIterator(zeek::RecordVal* v, ::TypeTag tag, zeek::Frame* f)
...
public:
	...
	RecordIterator(zeek::RecordVal* v, zeek::TypeTag tag, zeek::Frame* f)
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
	[[deprecated("Remove in v4.1. Use the version that takes zeek::TypeTag instead.")]]
	RecordIterator(zeek::RecordVal* v, ::TypeTag tag, zeek::Frame* f)

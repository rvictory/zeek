...
namespace zeek {
using ScopePtr = zeek::IntrusivePtr<zeek::Scope>;
...
public:
	...
	zeek::Val* Call(val_list* args, zeek::Frame* parent = nullptr) const;
	...
	virtual zeek::ValPtr Invoke(
		zeek::Args* args, zeek::Frame* parent = nullptr) const = 0;
	...
	virtual void SetScope(zeek::ScopePtr newscope);
	virtual zeek::Scope* GetScope() const		{ return scope.get(); }
...
public:
	...
	zeek::ValPtr Invoke(zeek::Args* args, zeek::Frame* parent) const override;
	 ...
	 */
	void AddClosure(id_list ids, zeek::Frame* f);
	 ...
	 */
	bool StrengthenClosureReference(zeek::Frame* f);
...
protected:
	 ...
	 */
	void SetClosureFrame(zeek::Frame* f);
...
private:
	...
	zeek::Frame* closure = nullptr;
	bool weak_closure_ref = false;
};

using built_in_func = BifReturnVal (*)(zeek::Frame* frame, const zeek::Args* args);
...
struct function_ingredients {
	...
	// to build a function.
	function_ingredients(zeek::ScopePtr scope, zeek::detail::StmtPtr body);

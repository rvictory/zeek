...
std::string get_context_description(const zeek::detail::Stmt* stmt, const zeek::Frame* frame);

extern zeek::Frame* g_dbg_locals;	// variables created within debugger context
